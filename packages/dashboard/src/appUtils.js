...
const FILE_TYPE_MAP = (() => {
	const types = [
		{
			exts: ["jpg", "jpeg", "png", "gif", "webp", "svg", "bmp", "ico", "tiff", "tif", "avif", "heic", "heif"],
			icon: "image", color: "purple",
		},
		{
			exts: ["pdf"],
			icon: "picture_as_pdf", color: "red",
		},
		{
			exts: ["txt", "md", "csv", "log", "rtf", "json", "xml", "yaml", "yml", "html", "htm", "css", "js", "ts", "jsx", "tsx", "py", "rb", "go", "rs", "java", "c", "cpp", "h", "sh", "bat", "ps1", "sql"],
			icon: "description", color: "blue",
		},
		{
			exts: ["mp4", "mkv", "avi", "mov", "wmv", "flv", "webm", "m4v", "mpg", "mpeg"],
			icon: "movie", color: "deep-purple",
		},
		{
			exts: ["mp3", "wav", "flac", "aac", "ogg", "m4a", "wma", "opus", "aiff"],
			icon: "music_note", color: "pink",
		},
		{
			exts: ["zip", "tar", "gz", "rar", "7z", "bz2", "xz"],
			icon: "archive", color: "brown",
		},
		{
			exts: ["exe", "msi", "dmg", "bin", "dll", "app", "deb", "rpm"],
			icon: "build", color: "deep-orange",
		},
	];
	const map = {};
